...
const module8_purpleteam = {
  ...
  lessons: [
    // --- PHASE 1: LOG INJECTION & SYSTEMD FORENSICS (1-15) ---
    {
      ...
      why: "Purple teams inject logs to test if the SIEM alerts the Blue Team.",
    ...
    },
    {
      ...
      why: "Check if the kernel logged your test.",
    ...
    {
      title: "Tag Log Entry",
      why: "Inject a log with a specific service tag (-t) to simulate an app crash.",
    ...
    },
    {
      ...
      why: "Ensure the tag was captured.",
    ...
    },
    {
      ...
      why: "Query the modern Systemd journal for active logs.",
    ...
    },
    {
      ...
      why: "Read the system journal in reverse (newest first).",
    ...
    },
    {
      ...
      why: "Live-tail the system journal for active events.",
    ...
    },
    {
      ...
      why: "Filter only core kernel ring buffer messages.",
    ...
    },
    {
      ...
      why: "Filter logs for a specific service daemon.",
    ...
    },
    {
      ...
      why: "Filter only critical errors (Priority 0-3).",
    ...
    },
    {
      ...
      why: "Filter logs from the last 10 minutes.",
    ...
    },
    {
      ...
      why: "Filter logs ending 1 hour ago.",
    ...
    },
    {
      ...
      why: "Limit the output exactly like 'tail -n'.",
    ...
    },
    {
      ...
      why: "Check how much disk space the logs are consuming.",
    ...
    },
    {
      ...
      why: "Save the current journal kernel errors to a file.",
    ...
    // --- PHASE 2: KERNEL AUDITING (16-25) ---
    {
      ...
      why: "Check if the Linux Auditing System is running.",
    ...
    },
    {
      ...
      why: "View currently active kernel tracking rules.",
    ...
    },
    {
      ...
      why: "Create a rule to track who executes the 'ping' binary.",
    ...
    },
    {
      ...
      why: "Create a rule to track who reads the password file.",
    ...
    },
    {
      ...
      why: "Check that the kernel accepted the watches.",
      text: "Type <code>auditctl -l</code>",
      objective: "Type auditctl -l",
      xp: 15,
      check: (c, a) => c === "auditctl" && a.includes("-l"),
    },
    {
      ...
      why: "Use ausearch to look for audit events.",
    ...
    {
      title: "Search by Key",
      why: "Find events tagged with our shadow_read rule.",
    ...
    },
    {
      ...
      why: "Find events caused by the bash shell.",
    ...
    },
    {
      ...
      why: "Generate a summary of all executed files.",
    ...
    },
    {
      ...
      why: "Flush the kernel rules to clean up.",
    ...
    // --- PHASE 3: ADVANCED SOCKETS & FILE DESCRIPTORS (26-40) ---
    {
      ...
      why: "The 'ss' command is the modern, faster replacement for netstat.",
    ...
    },
    {
      ...
      why: "Show which process owns the listening socket.",
    ...
    },
    {
      ...
      why: "Get a quick count of all sockets by protocol.",
    ...
    },
    {
      ...
      why: "Only show sockets on port 22 (SSH).",
    ...
    },
    {
      ...
      why: "In Linux, everything is a file. lsof shows what is open.",
    ...
    {
      title: "LSOF by Port",
      why: "Find out what is running on port 80.",
    ...
    },
    {
      ...
      why: "Show all open IPv4 network files.",
    ...
    {
      title: "LSOF by User",
      why: "Show all files opened by root.",
    ...
    {
      title: "LSOF by PID",
      why: "Investigate what files process 1337 is touching.",
    ...
    },
    {
      ...
      why: "Show all established TCP connections.",
    ...
    },
    {
      ...
      why: "Hackers delete their malware, but it stays in memory if running.",
    ...
    {
      title: "Grep LSOF Log",
      why: "Pipe lsof to find specific interactions.",
    ...
    },
    {
      ...
      why: "You found PID 1337 touching critical files. Kill it.",
    ...
    },
    {
      ...
      why: "Ensure the socket is closed.",
    ...
    // --- PHASE 4: PACKET CAPTURE & ROOTKITS (41-55) ---
    {
      ...
      why: "Tcpdump captures network traffic for analysis.",
    ...
    },
    {
      ...
      why: "Listen specifically on the loopback interface (localhost).",
    ...
    {
      title: "Sniff by Port",
      why: "Capture traffic only on port 80.",
    ...
    {
      title: "Sniff by IP",
      why: "Capture traffic to/from a specific host.",
    ...
    },
    {
      ...
      why: "Save packet capture to a file for Wireshark analysis.",
    ...
    },
    {
      ...
      why: "Read the packets back out of the saved file.",
    ...
    },
    {
      ...
      why: "Scan the system for known kernel rootkits.",
    ...
    },
    {
      ...
      why: "Only show infected findings.",
    ...
    },
    {
      ...
      why: "Check if the Linux security module is enforcing profiles.",
    ...
    },
    {
      ...
      why: "Find world-writable files (massive security risk).",
    ...
    },
    {
      ...
      why: "Another tool to see bad authentication attempts.",
    ...
    {
      title: "Append LSOF",
      why: "Add open files to the report.",
    ...
    // --- PHASE 5: PURPLE TEAM VALIDATION LOOP (56-65) ---
    {
      ...
      why: "Red Team: Download an eicar test file to trigger defenses.",
    ...
    },
    {
      ...
      why: "Blue Team: Check if the Systemd journal caught the curl command.",
    ...
    {
      title: "Isolate IP",
      why: "Blue Team: Identify the C2 server IP.",
    ...
    },
    {
      ...
      why: "Blue Team: Block the IP using iptables.",
    ...
    },
    {
      ...
      why: "Red Team: Try to reach the server again to test the block.",
    ...
    },
    {
      ...
      why: "Blue Team: Watch the firewall drop the packet in real-time.",
    ...
    },
    {
      ...
      why: "Blue Team: Eradicate the test file.",
    ...
    },
    {
      ...
      why: "Blue Team: Ensure no backdoors spawned during the test.",
      text: "Type <code>ss -tulnp</code>",
      objective: "Type ss -tulnp",
      xp: 20,
      check: (c, a) => c === "ss" && a.includes("-tulnp"),
    },
    {
      ...
      why: "Purple Team: Log the successful test.",
