...
const module11_exploitation = {
  ...
  lessons: [
    // --- PHASE 1: HYDRA NETWORK BRUTE FORCING (1-20) ---
    {
      ...
      why: "Brute force an SSH login with a known user and wordlist.",
    ...
    },
    {
      ...
      why: "Attack the FTP service on a target.",
    ...
    },
    {
      ...
      why: "Brute force multiple users from a list instead of a single user (-L).",
    ...
    {
      title: "Hydra Verbose",
      why: "See every password attempt in real time (-V).",
    ...
    {
      title: "Hydra Threads",
      why: "Speed up the attack using multiple parallel tasks (-t).",
    ...
    },
    {
      ...
      why: "Attack an HTTP POST login form.",
    ...
    {
      title: "Hydra RDP",
      why: "Brute force a Windows Remote Desktop server.",
    ...
    {
      title: "Hydra SMB",
      why: "Brute force Windows File Sharing.",
    ...
    {
      title: "Hydra Telnet",
      why: "Attack the legacy Telnet protocol.",
    ...
    },
    {
      ...
      why: "Save cracked credentials to a file (-o).",
    ...
    },
    {
      ...
      why: "Attack a service running on a non-standard port (-s).",
    ...
    },
    {
      ...
      why: "Stop the brute force as soon as one password works (-f).",
    ...
    },
    {
      ...
      why: "Try logging in with an empty password (-e e).",
    ...
    },
    {
      ...
      why: "Try logging in using the username as the password (-e s).",
    ...
    },
    {
      ...
      why: "Try both empty and same-as-username passwords (-e ns).",
    ...
    {
      title: "Hydra MySQL",
      why: "Attack a database directly.",
    ...
    },
    {
      ...
      why: "Attack PostgreSQL database.",
    ...
    {
      title: "Hydra VNC",
      why: "Attack Virtual Network Computing.",
    ...
    },
    {
      ...
      why: "View the passwords you collected.",
    ...
    // --- PHASE 2: GOBUSTER & SQLMAP (21-40) ---
    {
      ...
      why: "Fuzz a website for hidden directories.",
    ...
    },
    {
      ...
      why: "Speed up fuzzing with 50 threads.",
    ...
    },
    {
      ...
      why: "Look for specific file types like .php and .bak.",
    ...
    },
    {
      ...
      why: "Hide annoying 404 Not Found errors.",
      text: "Type <code>gobuster dir -u http://10.0.0.50 -w words.txt -b 404</code>",
      objective: "Use -b 404",
      xp: 30,
      check: (c, a) =>
        c === "gobuster" && a.includes("-b") && a.includes("404"),
    },
    {
      title: "Gobuster Subdomains",
      why: "Fuzz for hidden subdomains (DNS mode).",
    ...
    },
    {
      ...
      why: "Fuzz for virtual hosts on the same IP.",
    ...
    },
    {
      ...
      why: "Save discovered paths to a file.",
    ...
    {
      title: "Read Dirs Log",
      why: "View your discovered hidden paths.",
    ...
    {
      title: "SQLMap Basic",
      why: "Test a URL parameter for SQL injection.",
    ...
    },
    {
      ...
      why: "Auto-answer 'yes' to all prompts (-batch).",
    ...
    },
    {
      ...
      why: "Ask SQLMap to list all databases.",
    ...
    },
    {
      ...
      why: "Select a specific database to target (-D).",
    ...
    },
    {
      ...
      why: "Select a specific table to target (-T).",
    ...
    },
    {
      ...
      why: "Extract all data from the targeted table.",
    ...
    },
    {
      ...
      why: "The nuclear option. Dump everything.",
    ...
    {
      title: "SQLMap Forms",
      why: "Automatically test all forms on a page.",
    ...
    {
      title: "SQLMap Crawl",
      why: "Crawl the site and test every link it finds.",
    ...
    },
    {
      ...
      why: "Test an HTTP POST request using a saved burp file.",
    ...
    },
    {
      ...
      why: "Attempt to spawn a command shell directly on the database server.",
    ...
    },
    {
      ...
      why: "Clear SQLMap's memory to test a target fresh.",
    ...
    // --- PHASE 3: MSFVENOM PAYLOADS (41-60) ---
    {
      ...
      why: "Generate a standard reverse shell for Windows.",
    ...
    {
      title: "MSF Linux ELF",
      why: "Generate a reverse shell for Linux.",
    ...
    },
    {
      ...
      why: "Generate a reverse shell for MacOS.",
    ...
    },
    {
      ...
      why: "Generate a PHP reverse shell for web servers.",
    ...
    },
    {
      ...
      why: "Generate an ASPX shell for IIS web servers.",
    ...
    },
    {
      ...
      why: "Generate a JSP shell for Tomcat servers.",
    ...
    },
    {
      ...
      why: "Generate a pure bash reverse shell.",
    ...
    },
    {
      ...
      why: "View all available payloads.",
    ...
    },
    {
      ...
      why: "View all output formats (exe, elf, raw, etc).",
    ...
    },
    {
      ...
      why: "Use Shikata Ga Nai to evade basic Antivirus.",
    ...
    },
    {
      ...
      why: "Encode the payload 5 times for better obfuscation (-i 5).",
    ...
    },
    {
      ...
      why: "Avoid bad characters like null bytes (\\x00) for exploit development.",
    ...
    },
    {
      ...
      why: "Generate payload in C format to paste into exploit code.",
    ...
    },
    {
      ...
      why: "Generate payload in Python array format.",
    ...
    },
    {
      ...
      why: "Generate a shell that listens on the target instead of connecting back.",
    ...
    },
    {
      ...
      why: "Generate the advanced Meterpreter payload.",
    ...
    },
    {
      ...
      why: "Generate the Linux version.",
    ...
    },
    {
      ...
      why: "Check your generated files.",
    ...
    // --- PHASE 4: PASSWORD CRACKING (JOHN & HASHCAT) (61-80) ---
    {
      ...
      why: "Combine /etc/passwd and /etc/shadow for John the Ripper.",
    ...
    {
      title: "John Basic",
      why: "Crack the unshadowed file using John the Ripper.",
    ...
    },
    {
      ...
      why: "View the cracked passwords.",
    ...
    },
    {
      ...
      why: "Force John to crack a specific hash type (e.g. raw-md5).",
    ...
    {
      title: "John Zip2John",
      why: "Extract the hash from a password-protected zip file.",
    ...
    },
    {
      ...
      why: "Crack the extracted zip hash.",
    ...
    {
      title: "John SSH2John",
      why: "Extract the hash from an encrypted SSH private key.",
    ...
    },
    {
      ...
      why: "Crack the ssh key passphrase.",
    ...
    {
      title: "Hashcat MD5",
      why: "Use Hashcat to crack an MD5 hash (Mode 0).",
    ...
    {
      title: "Hashcat SHA1",
      why: "Crack a SHA1 hash (Mode 100).",
    ...
    },
    {
      ...
      why: "Crack a SHA256 hash (Mode 1400).",
    ...
    {
      title: "Hashcat NTLM",
      why: "Crack Windows NTLM hashes (Mode 1000).",
    ...
    },
    {
      ...
      why: "Crack Linux /etc/shadow hashes (Mode 1800).",
    ...
    },
    {
      ...
      why: "View the successfully cracked hashes.",
    ...
    {
      title: "Hashcat Rules",
      why: "Apply mutation rules (like appending numbers) to your wordlist.",
    ...
    {
      title: "Hashcat Force",
      why: "Ignore warnings and force execution.",
    ...
    },
    {
      ...
      why: "Create a small text file of passwords for testing.",
    ...
    },
    {
      ...
      why: "Add another common password.",
    ...
    },
    {
      ...
      why: "Run hashcat with your tiny custom list.",
    ...
    {
      title: "Netcat Listen",
      why: "Set up a listening server on port 4444 (-l = listen, -v = verbose, -n = numeric, -p = port).",
    ...
    },
    {
      ...
      why: "Connect out to another host on port 4444.",
    ...
    },
    {
      ...
      why: "Use netcat to scan for open ports (-z = zero-I/O mode).",
    ...
    },
    {
      ...
      why: "Listen on a port and save incoming data to a file.",
    ...
    },
    {
      ...
      why: "Connect and push a file across the network.",
    ...
    },
    {
      ...
      why: "The holy grail. Push a bash shell (-e) to your listening machine.",
    ...
    },
    {
      ...
      why: "Push a basic sh shell (if bash isn't available).",
    ...
    },
    {
      ...
      why: "Bind a shell to a listening port so someone can connect TO you.",
    ...
    },
    {
      ...
      why: "A basic nc shell lacks features. Upgrade it with Python.",
    ...
    },
    {
      ...
      why: "Background the netcat session so you can fix terminal settings.",
    ...
    {
      title: "Stty Raw",
      why: "Allow special keys (Ctrl+C, Tab) to pass through to the target shell.",
    ...
    },
    {
      ...
      why: "Bring the shell back after fixing stty.",
    ...
    },
    {
      ...
      why: "Tell the target shell what kind of terminal you are using.",
    ...
    },
    {
      ...
      why: "If netcat doesn't have the -e flag, use bash redirection.",
    ...
    },
    {
      ...
      why: "Create a reverse shell using Python.",
    ...
    },
    {
      ...
      why: "Create a reverse shell using PHP CLI.",
    ...
    },
    {
      ...
      why: "Create a reverse shell using Ruby.",
    ...
    },
    {
      ...
      why: "Create a reverse shell using Perl.",
    ...
    },
    {
      ...
      why: "Verify your listening ports using modern tools.",
    ...
    },
    {
      ...
      why: "You have mastered weaponization.",
